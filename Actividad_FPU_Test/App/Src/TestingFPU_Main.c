/**
 ******************************************************************************
 * @file           : TestingFPU_Main.c
 * @author         : Miller Quintero - miquinterog@unal.edu.co
 * @brief          : Testing Float Point Unit
 ******************************************************************************
 * Archivo principal con el código para testear
 * el correcto funcionamiento de la unidad de punto flotante
 ******************************************************************************
 */
