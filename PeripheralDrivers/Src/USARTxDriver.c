	...
	if((RCC->CFGR & RCC_CFGR_SW) == RCC_CFGR_SW_PLL){
		if((ptrUsartHandler->ptrUSARTx == USART1)||(ptrUsartHandler->ptrUSARTx == USART6)){
			...
			if(ptrUsartHandler->USART_Config.USART_baudrate == USART_BAUDRATE_9600){
				...
				// Mantiza = 325 = 0x145, fraction = 16 * 0.5208 = 8.33 = 8
			...
			if(ptrUsartHandler->USART_Config.USART_baudrate == USART_BAUDRATE_9600){
				...
				// Mantiza = 160 = 0x0A2, fraction = 16 * 0.7604 = 12.1664 = 12
				// Valor a cargar 0x0A2C
				// Configurando el Baudrate generator para una velocidad de 19200bps
...
//				ptrUsartHandler->ptrUSARTx->BRR = baudrate;
				...
				// Mantiza = 13 = 0xD, fraction = 16 * 0.5634 = 9.0144 = 9
				// Valor a cargar 0x00D9
				// Configurando el Baudrate generator para una velocidad de 230400bps
	...
	// Ver tabla de valores (Tabla 75), Frec = 16MHz, over8 = 0;
		...
		else if(ptrUsartHandler->USART_Config.USART_baudrate == USART_BAUDRATE_460800){
			// El valor a cargar es 2.1875 -> Mantiza = 2,fraction = 0.1875
			// Mantiza = 2 = 0x2, fraction = 16 * 0.1875 = 3
			// Valor a cargar 0x0023
			// Configurando el Baudrate generator para una velocidad de 57600bps
